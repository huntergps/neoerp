...
class DespachoMainInfoMobil extends ConsumerWidget {
  const DespachoMainInfoMobil({this.registroActual, Key? key})
      : super(key: key);
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Button(
                  onPressed: () {
                    ...
                    despachoRefreshEstadoFacturas(context, ref, despachoId,
                        'despachos_verificar_facturas');
                  },
              ...
              Card(
                ...
                child: Text(
                  statePickingOrderField[registroActual!.state]!.toUpperCase(),
                  style: theme.typography.subtitle!.copyWith(fontSize: 13.0),
                ),
              ),
            ],
          ),
            ...
            Row(
              children: [
                if (modoEdicion) ...[
                  ...
                  ConstrainedBox(
                    constraints:
                        const BoxConstraints(maxWidth: 220, minWidth: 180),
                    child: ComboListado(
                ...
                if (modoEdicion) ...[
                  ...
                  ComboSearch<PartnerList>(
                    ...
                    itemBuilder: listadoTransportistas, //listadoTransportistas,
