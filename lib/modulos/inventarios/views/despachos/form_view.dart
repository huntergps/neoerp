...
class _DespachoFormFormState extends ConsumerState<DespachoForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final StockMoveList move =
        darMoveActualFormularioProviderNotifier(ref).state;

    final isPhone = DeviceScreen.isPhone(context);
    final altoNormal = isPhone ? 250.00 : 550.00;
    final double alto = registroActual.moveLinesData!.length > 10
        ? 31 * registroActual.moveLinesData!.length.toDouble()
        : altoNormal;
