import 'package:neo/widgets/card_highlight.dart';
import 'package:fluent_ui/fluent_ui.dart';

import '../../widgets/page.dart';

class OrdenesSatPage extends StatefulWidget {
  const OrdenesSatPage({Key? key}) : super(key: key);

  @override
  State<OrdenesSatPage> createState() => _OrdenesSatPageState();
}

class _OrdenesSatPageState extends State<OrdenesSatPage> with PageMixin {
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage.scrollable(
      header: const PageHeader(title: Text('Ordenes de SAT')),
      children: const [
        Text(
          'Listado de Ordenes de Soporte Tecnico',
        ),
      ],
    );
  }
